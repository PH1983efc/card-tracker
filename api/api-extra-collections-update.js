// Save as: api/extra-collections-update.js

import { google } from 'googleapis';

export const config = { api: { bodyParser: true } };

const SHEET_NAME = 'Extra Collections';
const GOT_COLUMN = 'H'; // Column H = Got
...
export default async function handler(req, res) {
  try {
    ...
    console.error('Extra Collections update error:', err.message);
